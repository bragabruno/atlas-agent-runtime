"""Alembic migration environment for atlas-agent-runtime (AGT-2).

Wires Alembic to the SQLAlchemy schema declared in `app.persistence` so
...
the alembic.ini value is an inert placeholder. See atlas-docs/03 §1.7.
"""
...
from app.persistence import tables  # noqa: F401  (registers models on Base.metadata)
